...
> [!NOTE]
> Ensure you are running these commands in PowerShell and that your terminal is located inside the `G:\atm-management-system\frontend` folder.
...
```powershell
$env:JAVA_HOME="C:\Program Files\Java\jdk-25"; .\mvnw.cmd clean compile javafx:jlink
```
...
```powershell
$env:JAVA_HOME="C:\Program Files\Java\jdk-25"; jpackage --type app-image --dest target/MyNewBuild --name "BanglaBankATM" --module com.example.atmmanagementsystem/com.example.atmmanagementsystem.BanglaBankApplication --runtime-image target/app
```

> [!TIP]  
> After running this command, your new application will be waiting for you inside `frontend\target\MyNewBuild\BanglaBankATM`. You can zip this folder up to share it with anyone!
